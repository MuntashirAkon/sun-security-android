...
public class X500Name implements android.sun.security.x509.GeneralNameInterface, Principal {
    ...
    private android.sun.security.x509.RDN[] names;        // RDNs (never null)
    private X500Principal x500Principal;
    private byte[] encoded;

    // cached immutable list of the RDNs and all the AVAs
    private volatile List<android.sun.security.x509.RDN> rdnList;
    private volatile List<android.sun.security.x509.AVA> allAvaList;
    ...
    throws IOException {
        names = new android.sun.security.x509.RDN[4];
        /*
         * NOTE:  it's only on output that little-endian
         * ordering is used.
         */
        names[3] = new android.sun.security.x509.RDN(1);
        names[3].assertion[0] = new android.sun.security.x509.AVA(commonName_oid,
                new android.sun.security.util.DerValue(commonName));
        names[2] = new android.sun.security.x509.RDN(1);
        names[2].assertion[0] = new android.sun.security.x509.AVA(orgUnitName_oid,
                new android.sun.security.util.DerValue(organizationUnit));
        names[1] = new android.sun.security.x509.RDN(1);
        names[1].assertion[0] = new android.sun.security.x509.AVA(orgName_oid,
                new android.sun.security.util.DerValue(organizationName));
        names[0] = new android.sun.security.x509.RDN(1);
        names[0].assertion[0] = new android.sun.security.x509.AVA(countryName_oid,
                new android.sun.security.util.DerValue(country));
    }
    ...
    throws IOException {
        names = new android.sun.security.x509.RDN[6];
        /*
         * NOTE:  it's only on output that little-endian
         * ordering is used.
         */
        names[5] = new android.sun.security.x509.RDN(1);
        names[5].assertion[0] = new android.sun.security.x509.AVA(commonName_oid,
                new android.sun.security.util.DerValue(commonName));
        names[4] = new android.sun.security.x509.RDN(1);
        names[4].assertion[0] = new android.sun.security.x509.AVA(orgUnitName_oid,
                new android.sun.security.util.DerValue(organizationUnit));
        names[3] = new android.sun.security.x509.RDN(1);
        names[3].assertion[0] = new android.sun.security.x509.AVA(orgName_oid,
                new android.sun.security.util.DerValue(organizationName));
        names[2] = new android.sun.security.x509.RDN(1);
        names[2].assertion[0] = new android.sun.security.x509.AVA(localityName_oid,
                new android.sun.security.util.DerValue(localityName));
        names[1] = new android.sun.security.x509.RDN(1);
        names[1].assertion[0] = new android.sun.security.x509.AVA(stateName_oid,
                new android.sun.security.util.DerValue(stateName));
        names[0] = new android.sun.security.x509.RDN(1);
        names[0].assertion[0] = new android.sun.security.x509.AVA(countryName_oid,
                new android.sun.security.util.DerValue(country));
    }
     ...
     */
    public X500Name(android.sun.security.x509.RDN[] rdnArray) throws IOException {
        if (rdnArray == null) {
            names = new android.sun.security.x509.RDN[0];
        } else {
     ...
     */
    public X500Name(android.sun.security.util.DerValue value) throws IOException {
     ...
     */
    public X500Name(android.sun.security.util.DerInputStream in) throws IOException {
        parseDER(in);
    }
    ...
    public X500Name(byte[] name) throws IOException {
        android.sun.security.util.DerInputStream in = new android.sun.security.util.DerInputStream(name);
        parseDER(in);
    }
     ...
     */
    public List<android.sun.security.x509.RDN> rdns() {
        List<android.sun.security.x509.RDN> list = rdnList;
        if (list == null) {
     ...
     */
    public List<android.sun.security.x509.AVA> allAvas() {
        List<android.sun.security.x509.AVA> list = allAvaList;
        if (list == null) {
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = 0; i < n; i++) {
            android.sun.security.x509.RDN r1 = this.names[i];
            android.sun.security.x509.RDN r2 = other.names[i];
     ...
     */
    private String getString(android.sun.security.util.DerValue attribute) throws IOException {
        if (attribute == null)
            return null;
     ...
     */
    public int getType() {
        return (android.sun.security.x509.GeneralNameInterface.NAME_DIRECTORY);
    }
    ...
    public String getCountry() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(countryName_oid);
    ...
    public String getOrganization() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(orgName_oid);
    ...
    public String getOrganizationalUnit() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(orgUnitName_oid);
    ...
    public String getCommonName() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(commonName_oid);
    ...
    public String getLocality() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(localityName_oid);
    ...
    public String getState() throws IOException {
      android.sun.security.util.DerValue attr = findAttribute(stateName_oid);
    ...
    public String getDomain() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(DOMAIN_COMPONENT_OID);
    ...
    public String getDNQualifier() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(DNQUALIFIER_OID);
    ...
    public String getSurname() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(SURNAME_OID);
    ...
    public String getGivenName() throws IOException {
       android.sun.security.util.DerValue attr = findAttribute(GIVENNAME_OID);
    ...
    public String getInitials() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(INITIALS_OID);
    ...
    public String getGeneration() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(GENERATIONQUALIFIER_OID);
    ...
    public String getIP() throws IOException {
        android.sun.security.util.DerValue attr = findAttribute(ipAddress_oid);
     ...
     */
    private android.sun.security.util.DerValue findAttribute(android.sun.security.util.ObjectIdentifier attribute) {
        if (names != null) {
            for (int i = 0; i < names.length; i++) {
                android.sun.security.util.DerValue value = names[i].findAttribute(attribute);
                if (value != null) {
                    return value;
                }
            }
     ...
     * type.
     */
    public android.sun.security.util.DerValue findMostSpecificAttribute(android.sun.security.util.ObjectIdentifier attribute) {
        if (names != null) {
            for (int i = names.length - 1; i >= 0; i--) {
                android.sun.security.util.DerValue value = names[i].findAttribute(attribute);
                if (value != null) {
    ...
    private void parseDER(android.sun.security.util.DerInputStream in) throws IOException {
        //
        ...
        //
        android.sun.security.util.DerValue[] nameseq = null;
        ...
        try {
            ...
            if (derBytes == null) {
                ...
                android.sun.security.util.DerValue derVal = new android.sun.security.util.DerValue(android.sun.security.util.DerValue.tag_Sequence,
                                           derBytes);
                derBytes = derVal.toByteArray();
                nameseq = new android.sun.security.util.DerInputStream(derBytes).getSequence(5);
            }
        }
        ...
        if (nameseq == null) {
            ...
            names = new android.sun.security.x509.RDN[nameseq.length];
            for (int i = 0; i < nameseq.length; i++) {
                names[i] = new android.sun.security.x509.RDN(nameseq[i]);
            }
        }
    }
     ...
     */
    @Deprecated
    public void emit(android.sun.security.util.DerOutputStream out) throws IOException {
        encode(out);
    }
    ...
    private void parseDN(String input, Map<String, String> keywordMap)
        ...
        List<android.sun.security.x509.RDN> dnVector = new ArrayList<android.sun.security.x509.RDN>();
        int dnOffset = 0;
        int rdnEnd;
        String rdnString;
        int quoteCount = 0;
        ...
        while (nextComma >=0 || nextSemiColon >=0) {
            ...
            if (rdnEnd >= 0 && quoteCount != 1 &&
                ...
                android.sun.security.x509.RDN rdn = new android.sun.security.x509.RDN(rdnString, keywordMap);
                dnVector.add(rdn);
        ...
        names = dnVector.toArray(new android.sun.security.x509.RDN[dnVector.size()]);
    }
    ...
    private void parseRFC2253DN(String dnString) throws IOException {
        ...
        while (rdnEnd >=0) {
            ...
            if (rdnEnd > 0 && !escaped(rdnEnd, searchOffset, dnString)) {
                ...
                // Parse RDN, and store it in vector
                android.sun.security.x509.RDN rdn = new android.sun.security.x509.RDN(rdnString, "RFC2253");
                dnVector.add(rdn);
     ...
     */
    static android.sun.security.util.ObjectIdentifier intern(android.sun.security.util.ObjectIdentifier oid) {
        android.sun.security.util.ObjectIdentifier interned = internedOIDs.get(oid);
        if (interned != null) {
            return interned;
        }
    ...
    private static final Map<android.sun.security.util.ObjectIdentifier, android.sun.security.util.ObjectIdentifier> internedOIDs
                        = new HashMap<android.sun.security.util.ObjectIdentifier, android.sun.security.util.ObjectIdentifier>();
    ...
    public static final android.sun.security.util.ObjectIdentifier commonName_oid;
    public static final android.sun.security.util.ObjectIdentifier countryName_oid;
    public static final android.sun.security.util.ObjectIdentifier localityName_oid;
    public static final android.sun.security.util.ObjectIdentifier orgName_oid;
    public static final android.sun.security.util.ObjectIdentifier orgUnitName_oid;
    public static final android.sun.security.util.ObjectIdentifier stateName_oid;
    public static final android.sun.security.util.ObjectIdentifier streetAddress_oid;
    public static final android.sun.security.util.ObjectIdentifier title_oid;
    public static final android.sun.security.util.ObjectIdentifier DNQUALIFIER_OID;
    public static final android.sun.security.util.ObjectIdentifier SURNAME_OID;
    public static final android.sun.security.util.ObjectIdentifier GIVENNAME_OID;
    public static final android.sun.security.util.ObjectIdentifier INITIALS_OID;
    public static final android.sun.security.util.ObjectIdentifier GENERATIONQUALIFIER_OID;
    public static final android.sun.security.util.ObjectIdentifier ipAddress_oid;
    public static final android.sun.security.util.ObjectIdentifier DOMAIN_COMPONENT_OID;
    public static final android.sun.security.util.ObjectIdentifier userid_oid;
    public static final ObjectIdentifier SERIALNUMBER_OID;

    static {
    /** OID for the "CN=" attribute, denoting a person's common name. */
        commonName_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(commonName_data));
    ...
    /** OID for the "SERIALNUMBER=" attribute, denoting a serial number for.
        ...
        SERIALNUMBER_OID = intern(android.sun.security.util.ObjectIdentifier.newInternal(SERIALNUMBER_DATA));

    /** OID for the "C=" attribute, denoting a country. */
        countryName_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(countryName_data));

    /** OID for the "L=" attribute, denoting a locality (such as a city) */
        localityName_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(localityName_data));

    /** OID for the "O=" attribute, denoting an organization name */
        orgName_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(orgName_data));

    /** OID for the "OU=" attribute, denoting an organizational unit name */
        orgUnitName_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(orgUnitName_data));

    /** OID for the "S=" attribute, denoting a state (such as Delaware) */
        stateName_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(stateName_data));

    /** OID for the "STREET=" attribute, denoting a street address. */
        streetAddress_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(streetAddress_data));

    /** OID for the "T=" attribute, denoting a person's title. */
        title_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(title_data));

    /** OID for the "DNQUALIFIER=" or "DNQ=" attribute, denoting DN
        disambiguating information.*/
        DNQUALIFIER_OID = intern(android.sun.security.util.ObjectIdentifier.newInternal(DNQUALIFIER_DATA));

    /** OID for the "SURNAME=" attribute, denoting a person's surname.*/
        SURNAME_OID = intern(android.sun.security.util.ObjectIdentifier.newInternal(SURNAME_DATA));

    /** OID for the "GIVENNAME=" attribute, denoting a person's given name.*/
        GIVENNAME_OID = intern(android.sun.security.util.ObjectIdentifier.newInternal(GIVENNAME_DATA));

    /** OID for the "INITIALS=" attribute, denoting a person's initials.*/
        INITIALS_OID = intern(android.sun.security.util.ObjectIdentifier.newInternal(INITIALS_DATA));

    /** OID for the "GENERATION=" attribute, denoting Jr., II, etc.*/
        GENERATIONQUALIFIER_OID =
            intern(android.sun.security.util.ObjectIdentifier.newInternal(GENERATIONQUALIFIER_DATA));
    ...
    /** OID for "IP=" IP address attributes, used with SKIP. */
        ipAddress_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(ipAddress_data));
     ...
     */
        DOMAIN_COMPONENT_OID =
            intern(android.sun.security.util.ObjectIdentifier.newInternal(DOMAIN_COMPONENT_DATA));

    /** OID for "UID=" denoting a user id, defined in RFCs 1274 & 2798. */
        userid_oid = intern(android.sun.security.util.ObjectIdentifier.newInternal(userid_data));
    }
    ...
    public X500Name commonAncestor(X500Name other) {
        ...
        android.sun.security.x509.RDN[] ancestor = new RDN[i];
        for (int j=0; j < i; j++) {
            ancestor[j] = names[j];
        }
